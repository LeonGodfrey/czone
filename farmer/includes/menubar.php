  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a>
            <div class="user-photo m-b-30"> <img class="img-fluid" src = "../images/<?php echo $farmer['photo']; ?>" widith= "150px" height="200px" alt="Avatar"/></div>
            <div class="col-sm-6">
              <h4 class="m-0"><?php echo $farmer['name']; ?></h4>
            </div>
          </a>
        </li>
